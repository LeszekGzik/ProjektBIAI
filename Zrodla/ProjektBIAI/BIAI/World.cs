...
namespace ProjektBIAI
{
    ...
    { 
        ...
        /// <summary>
        /// Konstruktor nowego świata, z losowo generowaną populacją
        /// </summary>
        ...
        /// <summary>
        /// Konstruktor świata z populacją wcześniej zaimportowaną z pliku
        /// </summary>
        ...
        /// </summary>
        /// <param name="crossoverChance">Szansa krzyżowania w ogóle</param>
        /// <param name="singlePointChance">Szansa krzyżowania w jednym punkcie, pozostałe będą w dwóch punktach</param>
        /// <param name="status">Label z aktualnym stanem obliczeń</param>
        ...
        /// </summary>
        /// <param name="mutationRate">Prawdopodobieństwo wystąpienia mutacji</param>
        /// <param name="mutationValue">Wartość mutacji (zastosowanie zależy od typu)</param>
        /// <param name="mutationType">Typ mutacji (none, random, constant lub percent)</param>
        /// <param name="status">Label z aktualnym stanem obliczeń</param>
        ...
        /// <summary>
        /// Selekcja całej populacji
        /// </summary>
        /// <param name="linearIndex">True jeśli selekcja rankingiem liniowym, false == selekcja kołem ruletki</param>
        /// <param name="status">Label z aktualnym stanem obliczeń</param>
